...
use App\Tool\CCPRestSmsSDK;

class SendTemplateSMS{
//主帐号,对应开官网发者主账号下的 ACCOUNT SID
    protected $accountSid= '8a48b5515350d1e2015354658a380525';

//主帐号令牌,对应官网开发者主账号下的 AUTH TOKEN
    protected $accountToken= '3cbd1ffeb0874cc1a5a86d14596bd40a';

//应用Id，在官网应用列表中点击应用，对应应用详情中的APP ID
//在开发调试的时候，可以使用官网自动为您分配的测试Demo的APP ID
    protected $appId='aaf98f895350b6880153546a80910666';
