    ...
    <div class="f-left right-side-panel" >
        ...
        <div class="breadcrumb-nav">
            <div class="ui  large breadcrumb">
                ...
                <a class="section">编辑商品属性</a>
            </div>
        </div>

        <form class="new-product-form" action="{{url('/weixin/admin/product/editProductSpec')}}" method="post">

            <input type="hidden" id="productId" name="productId" value="{{$productId}}" />
            <input type="hidden" id="changedSpecs" value=""/>
            {!! csrf_field() !!}
